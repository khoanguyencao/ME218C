...
#define SERV_0_HEADER "OPAMP.h"
// the name of the Init function
#define SERV_0_INIT InitOPAMP
// the name of the run function
#define SERV_0_RUN RunOPAMP
...
#if NUM_SERVICES > 1
// the header file with the public function prototypes
#define SERV_1_HEADER "OLEDService.h"
// the name of the Init function
#define SERV_1_INIT InitOLEDService
// the name of the run function
#define SERV_1_RUN RunOLEDService
// How big should this services Queue be?
...
#if NUM_SERVICES > 2
// the header file with the public function prototypes
#define SERV_2_HEADER "Comms.h"
// the name of the Init function
#define SERV_2_INIT InitComms
// the name of the run function
#define SERV_2_RUN RunComms
// How big should this services Queue be?
...
#if NUM_SERVICES > 3
// the header file with the public function prototypes
#define SERV_3_HEADER "TVS.h"
// the name of the Init function
#define SERV_3_INIT InitTVS
// the name of the run function
#define SERV_3_RUN RunTVS
// How big should this services Queue be?
...
#if NUM_SERVICES > 4
// the header file with the public function prototypes
#define SERV_4_HEADER "ZENER.h"
// the name of the Init function
#define SERV_4_INIT InitZENER
// the name of the run function
#define SERV_4_RUN RunZENER
// How big should this services Queue be?
...
#if NUM_SERVICES > 5
// the header file with the public function prototypes
#define SERV_5_HEADER "OLEDService.h"
// the name of the Init function
#define SERV_5_INIT InitOLEDService
// the name of the run function
#define SERV_5_RUN RunOLEDService
// How big should this services Queue be?
...
#define TIMER0_RESP_FUNC PostZENER
#define TIMER1_RESP_FUNC PostZENER
#define TIMER2_RESP_FUNC PostOPAMP
...
#define TIMER12_RESP_FUNC PostComms
#define TIMER13_RESP_FUNC PostComms
#define TIMER14_RESP_FUNC PostComms
#define TIMER15_RESP_FUNC PostTVS
...
#define ZENER_UPDATE_TIMER          0
#define DAMAGE_TIMER                1
#define OPAMP_TIMER                 2 
#define OPAMP_TIMEOUT               12
#define TVS_TIMEOUT                 13
#define ZENER_TIMEOUT               14
#define POT_TIMER                   15
